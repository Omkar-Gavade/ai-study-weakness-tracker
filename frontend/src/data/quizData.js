...
export const TOPICS = {
  ...
  economy: [
    { id: 'national-income', name: 'भारतीय अर्थव्यवस्था',    desc: 'राष्ट्रीय उत्पन्न व आर्थिक संकल्पना' },
    { id: 'banking',         name: 'बँकिंग व महागाई',        desc: 'RBI, बँकिंग, पैसा व चलनफुगवटा' },
    { id: 'population',      name: 'लोकसंख्या व दारिद्र्य',   desc: 'लोकसंख्या, दारिद्र्य व बेरोजगारी' },
    { id: 'finance',         name: 'सार्वजनिक वित्त व योजना', desc: 'बजेट, वित्त आयोग व पंचवार्षिक योजना' },
  ],
  environment: [
